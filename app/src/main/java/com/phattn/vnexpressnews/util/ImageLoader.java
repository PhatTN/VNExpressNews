...
public class ImageLoader {
    ...
    /**
     * Load an image from a url into the given ImageView using the default placeholder
     * if available.
     *
     * @param url  The web URL of an image
     * @param imageView  The target ImageView to load the image into.
    ...
    private static class VariableWidthImageLoader extends BaseGlideUrlLoader<String> {
        ...
        /**
         *  If the URL contains a special variable width indicator (eg "__w-200-400-800_")
         *  we get the buckets from the URL (200, 400 and 800 in the example) and replace
         *  the URL with the best bucket for the requested with (the bucket immediately
         *  larger than the requested with).
         */
        @Override
